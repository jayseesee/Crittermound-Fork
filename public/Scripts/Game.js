...
var ticksPerSecond=20,game,GameController=function()
    ...
    $(".tabcontents").notify("Game Saved","info");
    this.saveCheck=60*ticksPerSecond;
    return t;
	}
